...
void loop()
{
  ...
  if (input == "0002" ) 
  {
    Serial.println("i ma going to run 动作2");
    delay(500);
    for(i=90;i>=50;i--) //舵机6
    {
      setposition(6,i);
  ...
  if (input == "0003" ) 
  {
    Serial.println("i am going to run 动作3 转身");
    delay(500);
    ...
    Serial.println("0003 转身 finished");
  }
  input = "";
